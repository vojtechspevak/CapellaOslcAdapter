...
/**
 * Base class that handles all functionality needed for exposing collections of
 * resources for specific SysML types The derived classes only need to specify
 * the target class and all the functionality is inherited
 */
public abstract class BaseCollectionServlet extends HttpServlet {
	...
	/**
	 * This constructor enforces the _targetClass property to be set in the derived
	 * Class
	 * 
	 * @param targetClass
	 */
	...
	/**
	 * generic functionality for handling the request, the method parses the request
	 * parameters and performs the required search depending on the type defined in
	 * the derived class
	 */
	@Override
