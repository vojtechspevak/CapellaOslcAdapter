...
public class SubsettingService
{
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aSubsetting != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/capella/oslc/sysml/subsetting.jsp");
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aSubsetting != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/capella/oslc/sysml/subsettingsmallpreview.jsp");
            httpServletResponse.addHeader(SysmlServerConstants.HDR_OSLC_VERSION, SysmlServerConstants.OSLC_VERSION_V2);
            addCORSHeaders(httpServletResponse);
            rd.forward(httpServletRequest, httpServletResponse);
            return;
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aSubsetting != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/capella/oslc/sysml/subsettinglargepreview.jsp");
            httpServletResponse.addHeader(SysmlServerConstants.HDR_OSLC_VERSION, SysmlServerConstants.OSLC_VERSION_V2);
            addCORSHeaders(httpServletResponse);
            rd.forward(httpServletRequest, httpServletResponse);
            return;
